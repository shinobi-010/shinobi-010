...
Stealthily building high-performance backend systems, APIs, and automation. Focused on core runtime internals, system design, and open-source collaboration.
...
* **📐 System Design & Architecture**
  ...
  * Scalability (Vertical & Horizontal scaling, High Availability)
  * Database Tuning (Read Replication, Sharding, Partitioning)
  * Microservices (API Gateways, HTTP Sync vs. Message Queue Async communication)
* **💻 Systems & Automation**
